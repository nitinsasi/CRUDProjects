...
<div class="container">
  ...
  <form class="form-horizontal"method="post" action="progresslist" role="form">
    <div class="form-group">
      <label class="control-label col-sm-2" for="name">Consultant Name   :</label>
      <div class="col-sm-4">
      <input type="text" class="form-control" name="name"  id="name" placeholder="Enter Consultant Name">
    </div>
    </div>
    <div class="form-group">
...
<div class="form-group">
       <label class="control-label col-sm-2" for="percentagecomplete">Percentage Complete </label>
    <div class="col-sm-4">  <input type="text" class="form-control" name="percentagecomplete"  id="percentagecomplete" placeholder="Enter Contact No ">
    </div></div>


<div class="form-group">
     <label class="control-label col-sm-2" for="taskperformed">Description of Task performed this Week :</label>
    <div class="col-sm-4">  <input type="text" class="form-control" name="taskperformed"  id="taskperformed" placeholder="Enter Total No. of Projects">
    </div></div>
