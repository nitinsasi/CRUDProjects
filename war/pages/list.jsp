...
<td><%=e.getProperty("percentagecomplete") %></td>
<td><%=e.getProperty("taskperformed") %></td>

<td><a href="update/<%=e.getProperty("projectname")%>"><span class="glyphicon glyphicon-edit"></span>Update</a> | <a href="delete/<%=e.getProperty("projectname")%>"><span class="glyphicon glyphicon-trash"></span>Delete</a></td>
			</tr>
