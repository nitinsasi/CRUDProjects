...
<div class="container">
            ...
            <!-- center left-->	
         	<div class="col-md-12">
              ...
              <div class="panel panel-default">
                  <div class="panel-heading"><h4> EnhancementForm</h4></div>
  ...
  <form class="form-horizontal"method="post" action="sendEmail" role="form">
...
<div class="form-group">
     <label class="control-label col-sm-2" for="EnhancementRequest">Enhancement Request Details - Textarea :</label>
    <div class="col-sm-4">  <input type="text" class="form-control" name="EnhancementRequest"  id="EnhancementRequest" placeholder="Enter Total No. of Projects">
    </div></div>

<div class="form-group">
     <label class="control-label col-sm-2" for="RequesterName">Requester Name :</label>
    <div class="col-sm-4">  <input type="text" class="form-control" name="RequesterName"  id="RequesterName" placeholder="Enter Total No. of Projects">
    </div></div>
